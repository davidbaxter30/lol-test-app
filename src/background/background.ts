import { windowNames, lolGameId } from "../consts";
...
class BackgroundController {
  ...
  private _windows = {};
  private leagueGameListener: OWGameListener;
  ...
  private constructor() {
    ...
    this.leagueGameListener = new OWGameListener({
